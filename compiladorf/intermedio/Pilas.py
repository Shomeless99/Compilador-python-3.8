class pila:
    ...
    def proceso(self,cadena):
        ...
        #print("Esta es la cadena como de que no jaja: "+str(self.cadena))
        #self.cadena2 = self.une(self.cadena)
        #print(self.cadena2)
        self.todo = self.jerarquia(cadena)
        #print("HOLA: "+str(self.todo))
        return self.todo
    ...
    def SumRes(self,array):
        ...
        while self.pos2 < self.vv2:
            ...
            if array[self.pos2] == '-' or array[self.pos2] == '+':
                ...
                self.c2 = self.pos2
                #Caso si se encuentra dos numeros
